...
public class NetworkService {
    ...
    //contiene los métodos del CRUD del servicio. En nuestro caso sólo unaconsulta
    ...
    private NetworkService(){
        ...
        listaPokemonApi=new ArrayList<Pokemon>();listaPokemonApiLiveData=new MutableLiveData<>();
    }
    ...
    public void getSiguientesPokemonsApi(){
        //creamos la llamada al servicio con los siguientes 20 pokemon desde el
        //indice offset
    ...
    public LiveData<List<Pokemon>> getListaPokemonApi() {
        ...
        //como el repositorio tambien mantiene la base de datos, evitamos abrir
        //retrofit si no lo pide
        //el usuario. Si el acceso al servicio web es fundamental en la app se
        //puede abrir retorofit en el constructor //en
        if(retrofit==null){
            iniciaRetrofit();
        }
